...
model_name = 'nasnet_fine_4_16_wu_2'
...
df_test = pd.read_csv('./data/rank/Tests/question.csv', header=None)
...
def f(index):
    return index, cv2.resize(cv2.imread('./data/rank/'+fnames_test[index]), (width, width))
